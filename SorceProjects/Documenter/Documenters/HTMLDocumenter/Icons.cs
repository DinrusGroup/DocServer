...
namespace BestCS.DocNet.Documenters.HTMLDocumenter
{
    ...
    static class Icons
    {
        ...
        private static string[] ALT_LABELS = new string[] { "Отсутствует",
                                                            "Сборка",
                                                            "Пространство Имён",
                                                            "Публичный Класс",
                                                            "Публичная Структура",
                                                            ...
                                                            "Защищённый Внутренняя Структура",
                                                            "Защищённый Внутренний Интерфейс",
                                                            "Защищённый Внутренний Делегат",
                                                            "Защищённый Внутренний Перечень",
                                                            "Защищённый Внутреннее Поле",
                                                            "Защищённый Внутренний Метод",
                                                            "Защищённый Внутреннее Свойство",
                                                            "Защищённый Внутренний Событие",
                                                            "Поле Перечня",
                                                            "Статический",
                                                            "Виртуальный",
                                                            "Абстрактный" };
