...
using BestCS.DocNet.MyReflection.Attributes;
...
namespace BestCS.DocNet.MyReflection.MetaClasses
{
  public class MyClassInfo : MetaClass, ISummarisableMember
  {
    ...
    protected virtual void CheckSupport(TypeDefinition typeDefinition)
    {
      ...
      if (Utils.IsDelegate(typeDefinition)) { metaType = "Делегат"; }
      else if (typeDefinition.IsClass) { metaType = "Класс"; }
      else if (typeDefinition.IsInterface) { metaType = "Интерфейс"; }
      else if (typeDefinition.IsValueType) { metaType = "Структура"; }
      else if (typeDefinition.IsEnum) { metaType = "Перечень"; }
    ...
    public static string ClassMembersGroupsToString(ClassMembersGroups classMembersGroupType)
    {
      ...
      {
        case ClassMembersGroups.PublicClasses: return "Публичные Классы";
        case ClassMembersGroups.PublicInterfaces: return "Публичные Интерфейсы";
        case ClassMembersGroups.PublicStructures: return "Публичные Стуктуры";
        case ClassMembersGroups.PublicDelegates: return "Публичные Делегаты";
        case ClassMembersGroups.PublicEnumerations: return "Публичные Перечисления";
        case ClassMembersGroups.PublicConstructors: return "Публичные Конструкторы";
        case ClassMembersGroups.PublicMethodsOverloads: return "Публичные Методы";
        case ClassMembersGroups.PublicFields: return "Публичные Поля";
        case ClassMembersGroups.PublicEvents: return "Публичные События";
        case ClassMembersGroups.PublicPropertiesOverloads: return "Публичные Свойства";
        case ClassMembersGroups.ProtectedClasses: return "Защищённые Классы";
        case ClassMembersGroups.ProtectedInterfaces: return "Защищённые Интерфейсы";
        case ClassMembersGroups.ProtectedStructures: return "Защищённые Стуктуры";
        case ClassMembersGroups.ProtectedDelegates: return "Защищённые Делегаты";
        case ClassMembersGroups.ProtectedEnumerations: return "Защищённые Перечисления";
        case ClassMembersGroups.ProtectedConstructors: return "Защищённые Конструкторы";
        case ClassMembersGroups.ProtectedMethodsOverloads: return "Защищённые Методы";
        case ClassMembersGroups.ProtectedFields: return "Защищённые Поля";
        case ClassMembersGroups.ProtectedEvents: return "Защищённые События";
        case ClassMembersGroups.ProtectedPropertiesOverloads: return "Защищённые Свойства";
        case ClassMembersGroups.InternalClasses: return "Внутренние Классы";
        case ClassMembersGroups.InternalInterfaces: return "Внутренние Интерфейсы";
        case ClassMembersGroups.InternalStructures: return "Внутренние Стуктуры";
        case ClassMembersGroups.InternalDelegates: return "Внутренние Делегаты";
        case ClassMembersGroups.InternalEnumerations: return "Внутренние Перечисления";
        case ClassMembersGroups.InternalConstructors: return "Внутренние Конструкторы";
        case ClassMembersGroups.InternalMethodsOverloads: return "Внутренние Методы";
        case ClassMembersGroups.InternalFields: return "Внутренние Поля";
        case ClassMembersGroups.InternalEvents: return "Внутренние События";
        case ClassMembersGroups.InternalPropertiesOverloads: return "Внутренние Свойства";
        case ClassMembersGroups.ProtectedInternalClasses: return "Защищённые Внутренние Классы";
        case ClassMembersGroups.ProtectedInternalInterfaces: return "Защищённые Внутренние Интерфейсы";
        case ClassMembersGroups.ProtectedInternalStructures: return "Защищённые Внутренние Стуктуры";
        case ClassMembersGroups.ProtectedInternalDelegates: return "Защищённые Внутренние Делегаты";
        case ClassMembersGroups.ProtectedInternalEnumerations: return "Защищённые Внутренние Перечисления";
        case ClassMembersGroups.ProtectedInternalConstructors: return "Защищённые Внутренние Конструкторы";
        case ClassMembersGroups.ProtectedInternalMethodsOverloads: return "Защищённые Внутренние Методы";
        case ClassMembersGroups.ProtectedInternalFields: return "Защищённые Внутренние Поля";
        case ClassMembersGroups.ProtectedInternalEvents: return "Защищённые Внутренние События";
        case ClassMembersGroups.ProtectedInternalPropertiesOverloads: return "Защищённые Внутренние Свойства";
        case ClassMembersGroups.PrivateClasses: return "Приватные Классы";
        case ClassMembersGroups.PrivateInterfaces: return "Приватные Интерфейсы";
        case ClassMembersGroups.PrivateStructures: return "Приватные Стуктуры";
        case ClassMembersGroups.PrivateDelegates: return "Приватные Делегаты";
        case ClassMembersGroups.PrivateEnumerations: return "Приватные Перечисления";
        case ClassMembersGroups.PrivateConstructors: return "Приватные Конструкторы";
        case ClassMembersGroups.PrivateMethodsOverloads: return "Приватные Методы";
        case ClassMembersGroups.PrivateFields: return "Приватные Поля";
        case ClassMembersGroups.PrivateEvents: return "Приватные События";
        case ClassMembersGroups.PrivatePropertiesOverloads: return "Приватные Свойства";
    ...
    public static string GetBaseGroupName(ClassMembersGroups classMembersGroupType)
    {
      switch (classMembersGroupType)
      {
        case ClassMembersGroups.PublicClasses: { return "Классы"; }
        case ClassMembersGroups.PublicInterfaces: { return "Интерфейсы"; }
        case ClassMembersGroups.PublicStructures: { return "Стуктуры"; }
        case ClassMembersGroups.PublicDelegates: { return "Делегаты"; }
        case ClassMembersGroups.PublicEnumerations: { return "Перечисления"; }
        case ClassMembersGroups.PublicFields: { return "Поля"; }
        case ClassMembersGroups.PublicConstructors: { return "Конструкторы"; }
        case ClassMembersGroups.PublicMethodsOverloads: { return "Методы"; }
        case ClassMembersGroups.PublicPropertiesOverloads: { return "Свойства"; }
        case ClassMembersGroups.PublicEvents: { return "События"; }
        case ClassMembersGroups.ProtectedClasses: { return "Классы"; }
        case ClassMembersGroups.ProtectedInterfaces: { return "Интерфейсы"; }
        case ClassMembersGroups.ProtectedStructures: { return "Стуктуры"; }
        case ClassMembersGroups.ProtectedDelegates: { return "Делегаты"; }
        case ClassMembersGroups.ProtectedEnumerations: { return "Перечисления"; }
        case ClassMembersGroups.ProtectedFields: { return "Поля"; }
        case ClassMembersGroups.ProtectedConstructors: { return "Конструкторы"; }
        case ClassMembersGroups.ProtectedMethodsOverloads: { return "Методы"; }
        case ClassMembersGroups.ProtectedPropertiesOverloads: { return "Свойства"; }
        case ClassMembersGroups.ProtectedEvents: { return "События"; }
        case ClassMembersGroups.InternalClasses: { return "Классы"; }
        case ClassMembersGroups.InternalInterfaces: { return "Интерфейсы"; }
        case ClassMembersGroups.InternalStructures: { return "Стуктуры"; }
        case ClassMembersGroups.InternalDelegates: { return "Делегаты"; }
        case ClassMembersGroups.InternalEnumerations: { return "Перечисления"; }
        case ClassMembersGroups.InternalFields: { return "Поля"; }
        case ClassMembersGroups.InternalConstructors: { return "Конструкторы"; }
        case ClassMembersGroups.InternalMethodsOverloads: { return "Методы"; }
        case ClassMembersGroups.InternalPropertiesOverloads: { return "Свойства"; }
        case ClassMembersGroups.InternalEvents: { return "События"; }
        case ClassMembersGroups.ProtectedInternalClasses: { return "Классы"; }
        case ClassMembersGroups.ProtectedInternalInterfaces: { return "Интерфейсы"; }
        case ClassMembersGroups.ProtectedInternalStructures: { return "Стуктуры"; }
        case ClassMembersGroups.ProtectedInternalDelegates: { return "Делегаты"; }
        case ClassMembersGroups.ProtectedInternalEnumerations: { return "Перечисления"; }
        case ClassMembersGroups.ProtectedInternalFields: { return "Поля"; }
        case ClassMembersGroups.ProtectedInternalConstructors: { return "Конструкторы"; }
        case ClassMembersGroups.ProtectedInternalMethodsOverloads: { return "Методы"; }
        case ClassMembersGroups.ProtectedInternalPropertiesOverloads: { return "Свойства"; }
        case ClassMembersGroups.ProtectedInternalEvents: { return "События"; }
        case ClassMembersGroups.PrivateClasses: { return "Классы"; }
        case ClassMembersGroups.PrivateInterfaces: { return "Интерфейсы"; }
        case ClassMembersGroups.PrivateStructures: { return "Стуктуры"; }
        case ClassMembersGroups.PrivateDelegates: { return "Делегаты"; }
        case ClassMembersGroups.PrivateEnumerations: { return "Перечисления"; }
        case ClassMembersGroups.PrivateFields: { return "Поля"; }
        case ClassMembersGroups.PrivateConstructors: { return "Конструкторы"; }
        case ClassMembersGroups.PrivateMethodsOverloads: { return "Методы"; }
        case ClassMembersGroups.PrivatePropertiesOverloads: { return "Свойства"; }
        case ClassMembersGroups.PrivateEvents: { return "События"; }
